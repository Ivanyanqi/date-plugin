...
- 新增 [package-lock.json](./package-lock.json)、[.gitignore](./.gitignore) 与 beta.2 发布说明
- GitHub Actions 升级为 `npm ci + release:preflight + test:ci`
- 版本检查逻辑继续向当前 [package.json](./package.json) 版本号收敛
...
- 补齐发布骨架，包括 [package.json](./package.json)、[LICENSE](./LICENSE)、兼容性说明、发布检查清单和发布说明
