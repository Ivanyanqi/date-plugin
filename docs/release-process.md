...
1. 检查 `package.json` 中的 `version`、`repository`、`homepage`、`bugs` 与 `exports`
...
5. 完善 `docs/release-notes-<version>.md`
...
9. 完善 `CHANGELOG.md`
10. 如本轮变更影响使用方式，更新 `README.md`
11. 检查 `docs/browser-compatibility.md` 是否仍与真实支持范围一致
...
1. 拉取仓库代码
2. 基于 `package-lock.json` 执行 `npm ci`
